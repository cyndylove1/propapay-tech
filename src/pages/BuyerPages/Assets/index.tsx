            ...
            <div className="relative h-[460px] rounded-xl border-[1px] border-[#E5E6E8] p-2 shadow-md">
              ...
              <div className="top-3 absolute left-0 flex items-center justify-between w-full px-3">
                ...
                <span className="flex items-center">
                  ...
                  >
                    <g filter="url(#filter0_d_2764_3662)">
                      <path
                      ...
                      />
                      <path
                        d="M32.2188 17.3285C29.9841 15.9577 28.0336 16.5101 26.8619 17.39C26.3815 17.7508 26.1413 17.9312 26 17.9312C25.8587 17.9312 25.6185 17.7508 25.138 17.39C23.9663 16.5101 22.0159 15.9577 19.7812 17.3285C16.8484 19.1274 16.1848 25.0624 22.9496 30.0695C24.2381 31.0232 24.8823 31.5 26 31.5C27.1176 31.5 27.7619 31.0232 29.0504 30.0695C35.8152 25.0624 35.1516 19.1274 32.2188 17.3285Z"
                        stroke="#12725B"
                        stroke-width="1.5"
                    ...
                    <defs>
                      ...
                      >
                        ...
                        <feBlend
                          ...
                          result="effect1_dropShadow_2764_3662"
                        />
                        <feBlend
                          mode="normal"
                          in="SourceGraphic"
                          in2="effect1_dropShadow_2764_3662"
                          result="shape"
                        />
                      </filter>
                    </defs>
