          ...
          {Array(6)
            ...
            .map(() => (
              <div className="relative h-[460px] rounded-xl border-[1px] border-neutral-200 p-2 shadow-md">
                ...
                {/* Overlay Content */}
                <div className="absolute left-0 top-3 flex w-full items-center justify-between px-3">
                  {/* House Label */}
                  ...
                  <span className="flex items-center">
                    ...
                    >
                      <g filter="url(#filter0_d_2764_8090)">
                        <path
                        ...
                        />
                        <path
                          d="M32.2188 17.3285C29.9841 15.9577 28.0337 16.5101 26.862 17.39C26.3816 17.7508 26.1414 17.9312 26 17.9312C25.8587 17.9312 25.6185 17.7508 25.1381 17.39C23.9664 16.5101 22.0159 15.9577 19.7812 17.3285C16.8484 19.1274 16.1848 25.0624 22.9496 30.0695C24.2381 31.0232 24.8824 31.5 26 31.5C27.1177 31.5 27.7619 31.0232 29.0504 30.0695C35.8153 25.0624 35.1516 19.1274 32.2188 17.3285Z"
                          stroke="#12725B"
                          stroke-width="1.5"
                      ...
                      <defs>
                        ...
                        >
                          ...
                          <feBlend
                            ...
                            result="effect1_dropShadow_2764_8090"
                          />
                          <feBlend
                            mode="normal"
                            in="SourceGraphic"
                            in2="effect1_dropShadow_2764_8090"
                            result="shape"
                          />
                        </filter>
                      </defs>
                ...
                <div className="px-2 py-4">
                  ...
                  <h5 className="pt-2 text-[14px] font-[500] leading-[20px] text-neutral-800">
                ...
                <div className="flex items-center justify-between px-2 pt-[10px]">
                  ...
                  <Button
                    ...
                    stroke="#12725B"
                    type="button"
                    className="h-[36px] w-[97px] rounded-[8px] border-[1px] border-brand-base text-[14px] text-brand-base"
                  />
                </div>
              </div>
            ))}
