    ...
    <>
      ...
      <div className="lg:flex-row flex flex-col mx-4">
        <div className="lg:w-[700px] w-full rounded-2xl border-[1px] border-[#E0E0E0]">
          ...
          <div className="px-4">
            <h2 className="pb-[10px] pt-[20px] text-[18px] font-[500] leading-[24px] text-[#2E2E2E]">
              Description
            </h2>
          ...
          <div className="mx-4 mt-[30px] lg:h-[144px] rounded-lg border-[1px] border-[#E0E0E0] bg-[#fafafa]">
            ...
            <div className="grid lg:grid-cols-4 grid-cols-2 md:grid-cols-3 gap-[16px] pl-2">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-[14px] font-[600] leading-[24px] text-[#2E2E2E]">
                  4 Bedrooms
                </h3>
              </div>
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-[14px] font-[600] leading-[24px] text-[#2E2E2E]">
                  3 Bathrooms
                </h2>
              </div>
              <div className="flex items-center gap-2">
          ...
          <h2 className="px-4 py-[20px] text-[18px] font-[500] leading-[24px] text-[#2E2E2E]">
            Location
          </h2>
        </div>
        <div className="lg:w-[270px] w-full mt-4 lg:mt-0 rounded-xl border-[1px] border-[#E5E6E8]">
          ...
          <div className="mx-2 mt-[20px] rounded-xl border-[1px] border-[#F5F6F6] bg-[#f5f6f6] px-[10px]">
            ...
            <div className="flex items-center gap-[20px]">
              ...
              <div>
                <h2 className="text-[18px] font-[500] leading-[24px] text-[#2E2E2E]">
                  Sophia Williams
                </h2>
                <h6 className="text-[12px] font-[400] leading-[16px] text-[#727272]">
                  Real Estate Agent
                </h6>
              </div>
            </div>
          ...
          <div className="mx-2 mt-[20px] rounded-xl bg-[#f5f6f6] px-2 pb-[20px]">
            ...
            <h5 className="text-[16px] font-[400] leading-[24px] text-[#2E2E2E]">
