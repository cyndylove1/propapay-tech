...
const InputConfirmPassword: React.FC<InputPasswordConfirmProps> = ({
  id,
  placeholder,
}) => {
  ...
  return (
    <>
      <div className="mt-[5px]">
        <div className="flex h-[56px] items-center justify-between gap-[7px] rounded-xl border-[1px] border-[#cfd2d1] px-4">
