    ...
    <>
      <div className="flex h-[80px] items-center justify-between px-2 xl:px-[60px]">
        ...
        <div className="flex items-center gap-[16px]">
          <h2 className="text-[12px] font-[500] leading-[20px] text-[#696E71] md:text-[14px]">
            Need help?
          </h2>
          <div className="flex h-[36px] w-[121px] items-center justify-center gap-[4px] rounded-[8px] border-[1px] border-[#CFD1D2]">
            <h2>
              <svg
                width="20"
                height="20"
            ...
            <span className="text-[14px] font-[600] leading-[20px] text-[#696E71]">
              Contact Us
            </span>
          </div>
          <span>
