  ...
  return (
    ...
    >
      ...
      <input
        type="date"
        ref={dateInputRef}
        className="w-full cursor-pointer appearance-none bg-transparent p-2 px-8 text-[14px] font-medium leading-[20px] text-neutral-950 outline-none [&::-webkit-calendar-picker-indicator]"
      />
    </div>
  );
};
