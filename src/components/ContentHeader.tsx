      ...
      <>
        <div className="flex items-center justify-between p-[20px] ">
          ...
          <div className="md:flex items-center hidden gap-4">
            ...
            >
              <span className={`${isActive ? "text-white" : "text-[#595D61]"}`}>
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
              ...
              <h3
                className={`text-[14px] font-[600] leading-[20px] ${isActive ? "text-white" : "text-[#595D61]"}`}
              >
                Grid
              </h3>
            </button>
            <button
              className={`flex h-[36px] w-[93px] items-center justify-center gap-[8px] rounded-lg border-[1px] border-[#E5E6E8] ${Active ? "bg-[#12725B] text-white" : "bg-white text-[#595D61]"}`}
              onClick={() => navigate(path)}
            >
              <span className={`${Active ? "text-white" : "text-[#595D61]"}`}>
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
              ...
              <h3
                className={`text-[14px] font-[600] leading-[20px] ${Active ? "text-white" : "text-[#595D61]"}`}
              >
                List
              </h3>
            </button>

            <button className="flex h-[36px] w-[93px] items-center justify-center gap-[8px] rounded-lg border-[1px] border-[#E5E6E8]">
              <span>
                <svg
                  width="20"
                  height="20"
              ...
              <h2 className="text-[14px] font-[600] leading-[20px] text-[#595D61]">
                Filter
              </h2>
            </button>
            <button
